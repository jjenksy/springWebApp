 ...
 * THis rest controller is used for interacting with the customer model and repo in order to
...
public class CustomerController {
    ...
    public Iterable users(@PathVariable Long id){
        ...
        //create a list and call the customerRepo findByuserName method to populate it
